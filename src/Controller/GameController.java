...
public class GameController {
    ...
    public void startGame() {
        ...
        // initialize board with findings first
        board.initializeFindings(findings, rareFindings, paths);
        // then deal cards
        board.dealCards(deck, players.get(0), players.get(players.size() - 1));
